define(['jquery.ui', '../../../../static/js/web/goods_selector.js'], function (ui, gSelector) {
    ...
    modal.initNavs = function () {
        modal.setNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'video', 'coupon', 'copyright'],
            2: ['notice', 'goods', 'search', 'fixedsearch'],
            20:['notice', 'goods', 'search', 'fixedsearch', 'pictures','icongroup', 'audio']
        };
